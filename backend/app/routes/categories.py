...
from app.schemas.category_schema import (
    ...
    CategoryFilterSchema, CategoryHierarchySchema
)
from app.utils.decorators import validate_request, paginate
from app.utils.constants import HTTP_STATUS, DEFAULT_CATEGORIES
...
def get_category_hierarchy():
    ...
    return jsonify({
        'categories': CategoryHierarchySchema(many=True).dump(roots)
    }), HTTP_STATUS.OK
